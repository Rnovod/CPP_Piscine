...
inline static void	call_NinjaTrap(void) {
	...
	NinjaTrap	Jrobot;
	FragTrap	Frobot("Frag");
	ScavTrap	Srobot("Scav");
	ClapTrap	Crobot("Clap");

	std::cout << std::endl;
	Jrobot.rangedAttack("Itachi");

	std::cout << std::endl;
	Jrobot.takeDamage(20);

	std::cout << std::endl;
	Jrobot.meleeAttack("Itachi");

	std::cout << std::endl;
	Jrobot.takeDamage(1000);

	std::cout << std::endl;
	Jrobot.beRepaired(100);

	std::cout << std::endl;
	Jrobot.takeDamage(1);

	std::cout << std::endl;
	Jrobot.ninjaShoebox(Jrobot);
	Jrobot.ninjaShoebox(Frobot);
	Jrobot.ninjaShoebox(Srobot);
	Jrobot.ninjaShoebox(Crobot);
	std::cout << std::endl;
